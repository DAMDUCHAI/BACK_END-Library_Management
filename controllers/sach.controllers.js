    ...
    try {
      if (name) {
        const [results] = await sequelize.query(
          ` select tbsaches.id,tbsaches.Ten, tbtacgia.Ten as 'TacGia',tbtheloais.Ten as 'TheLoai',tbnhaxuatbans.Ten as 'NXB',tbkesaches.Ten as 'KeSach',tbsaches.AnhSach,tbsaches.NamXB,tbsaches.Gia,tbsaches.SoLgDauSach,tbsaches.SoLgHienTai from tbsaches 
